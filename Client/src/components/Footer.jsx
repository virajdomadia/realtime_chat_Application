  ...
  return (
    <>
      <footer className="bg-background shadow mx-4 rounded-lg">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8 md:px-4">
          <div className="sm:flex sm:items-center sm:justify-between">
            <a className="flex items-center mb-4 sm:mb-0 space-x-3 text-primary">
              <img
            ...
            <ul className="flex flex-wrap items-center mb-6 text-sm text-gray-500">
              <li>
                <a href="#" className="hover:underline me-4 md:me-8">
                  About
                </a>
              </li>
              <li>
          ...
          <span className="block text-sm sm:text-center text-gray-500">
            © 2023 <a className="hover:underline">SwiftChat</a>. All Rights
            Reserved.
          </span>
        </div>
      </footer>
