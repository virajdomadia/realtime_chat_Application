    ...
    <nav className="">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between p-4 mx-auto">
        ...
        <button
          ...
          type="button"
          className="inline-flex items-center p-2 w-10 h-10 justify-center bg-gray-800 rounded-md text-white md:hidden"
        ...
        >
          <Link
            ...
            className="block py-1 px-2 text-white hover:text-[#111111]"
          >
