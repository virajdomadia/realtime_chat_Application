...
const OnlineUsersList = ({
  ...
  return (
    <section className="w-[29%] py-3 border-r px-2 lg:px-4 border-primarySecond">
      <div className="text-white flex items-center gap-2 p-1 px-2 lg:px-4">
        <svg
        ...
        >
          <path
            ...
            d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a"
          />
        </svg>
        <input
          type="text"
        ...
        {filteredOnlinePeople.map((userId) => {
          ...
          return (
            <Contact
              ...
              isOnline={true}
              avatarLink={avatarLink} // Include avatarLink for the Avatar component
            />
          );
        })}
